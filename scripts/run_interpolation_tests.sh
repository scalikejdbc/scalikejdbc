...
sbt "++2.12.13! -v" clean                        > logs/test_stdout.log
sbt "++2.12.13! -v" interpolation-macro/compile >> logs/test_stdout.log
sbt "++2.12.13! -v" interpolation/test          >> logs/test_stdout.log
