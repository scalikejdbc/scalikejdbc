...
sbt "++2.12.16! -v" clean                        > logs/test_stdout.log
sbt "++2.12.16! -v" interpolation-macro/compile >> logs/test_stdout.log
sbt "++2.12.16! -v" interpolation/test          >> logs/test_stdout.log
