...
sbt "++2.12.11! -v" clean                        > logs/test_stdout.log
sbt "++2.12.11! -v" interpolation-macro/compile >> logs/test_stdout.log
sbt "++2.12.11! -v" interpolation/test          >> logs/test_stdout.log
