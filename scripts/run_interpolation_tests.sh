...
sbt "++2.10.6! -v" clean                        > logs/test_stdout.log
sbt "++2.10.6! -v" interpolation-macro/compile >> logs/test_stdout.log
sbt "++2.10.6! -v" interpolation/test          >> logs/test_stdout.log
