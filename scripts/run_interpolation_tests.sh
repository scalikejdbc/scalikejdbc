...
sbt "++2.12.15! -v" clean                        > logs/test_stdout.log
sbt "++2.12.15! -v" interpolation-macro/compile >> logs/test_stdout.log
sbt "++2.12.15! -v" interpolation/test          >> logs/test_stdout.log
