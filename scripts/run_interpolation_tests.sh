...
sbt "++2.12.10! -v" clean                        > logs/test_stdout.log
sbt "++2.12.10! -v" interpolation-macro/compile >> logs/test_stdout.log
sbt "++2.12.10! -v" interpolation/test          >> logs/test_stdout.log
