...
sbt "++2.11.12! -v" clean                        > logs/test_stdout.log
sbt "++2.11.12! -v" interpolation-macro/compile >> logs/test_stdout.log
sbt "++2.11.12! -v" interpolation/test          >> logs/test_stdout.log
