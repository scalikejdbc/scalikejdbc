...
sbt 'set scalaVersion := "2.13.0"' \
  ...
  clean \
  "project core" 'set scalaVersion := "2.12.10"' publishSigned \
  "project config" 'set scalaVersion := "2.12.10"' publishSigned \
  "project interpolation-macro" 'set scalaVersion := "2.12.10"' publishSigned \
  "project interpolation" 'set scalaVersion := "2.12.10"' publishSigned \
  "project library" 'set scalaVersion := "2.12.10"' publishSigned \
  "project joda-time" 'set scalaVersion := "2.12.10"' publishSigned \
