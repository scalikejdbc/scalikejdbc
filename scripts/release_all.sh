...
sbt 'set scalaVersion := "2.13.0-RC1"' \
  clean \
  "project core" 'set scalaVersion := "2.13.0-RC1"' publishSigned \
  "project config" 'set scalaVersion := "2.13.0-RC1"' publishSigned \
  "project interpolation-macro" 'set scalaVersion := "2.13.0-RC1"' publishSigned \
  "project interpolation" 'set scalaVersion := "2.13.0-RC1"' publishSigned \
  "project library" 'set scalaVersion := "2.13.0-RC1"' publishSigned \
  "project joda-time" 'set scalaVersion := "2.13.0-RC1"' publishSigned \
  "project streams" 'set scalaVersion := "2.13.0-RC1"' publishSigned \
  "project syntax-support-macro" 'set scalaVersion := "2.13.0-RC1"' publishSigned \
  "project test" 'set scalaVersion := "2.13.0-RC1"' publishSigned \
  "project mapper-generator-core" 'set scalaVersion := "2.13.0-RC1"' publishSigned \
