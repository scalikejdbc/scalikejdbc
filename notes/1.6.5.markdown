ScalikeJDBC 1.6.5 has been released. Newly [IntelliJ IDEA Live Templates for ScalikeJDBC users](https://github.com/seratch/scalikejdbc/blob/master/tools-support/intellij/templates/scalikejdbc.xml) is created by @tototoshi.
