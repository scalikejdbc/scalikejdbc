...
libraryDependencies ++= Seq(
  "com.github.seratch" %% "scalikejdbc" % "1.6.0-SNAPSHOT",
  "com.github.seratch" %% "scalikejdbc-interpolation" % "1.6.0-SNAPSHOT",
  "com.github.seratch" %% "scalikejdbc-test" % "1.6.0-SNAPSHOT",
