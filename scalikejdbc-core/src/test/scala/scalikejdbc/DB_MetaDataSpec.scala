      ...
      try {
        ...
        for (
          ...
          if (driverClassName == "org.h2.Driver") {
            ...
            lower(act) should (contain("meta_members") and not contain ("meta_groups") and have size 2)
          }
        }
        ...
        for (
          ...
          lower(act) should (contain("public.meta_members") and not contain ("other.meta_groups") and have size 1)
        }
