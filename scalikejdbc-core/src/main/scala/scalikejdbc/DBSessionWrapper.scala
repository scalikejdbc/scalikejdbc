...
private[scalikejdbc] final class DBSessionWrapper(
  ...
  override def updateAndReturnGeneratedKey[T](template: String, params: Any*): T = {
    withAttributesSwitchedDBSession(_.updateAndReturnGeneratedKey[T](template, params: _*))
  }
