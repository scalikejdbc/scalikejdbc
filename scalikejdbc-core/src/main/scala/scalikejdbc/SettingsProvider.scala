...
final class SettingsProvider private (
    ...
    private[scalikejdbc] val driverNamesToChooseColumnNameForAutoGeneratedKeyRetrieval: Endo[Seq[String]],
    private[scalikejdbc] val queryCompletionListener: Endo[QueryCompletionListener],
  ...
  def copy(
    ...
    driverNamesToChooseColumnNameForAutoGeneratedKeyRetrieval: Endo[Seq[String]] = this.driverNamesToChooseColumnNameForAutoGeneratedKeyRetrieval,
    ...
    nameBindingSQLValidator: Endo[NameBindingSQLValidatorSettings] = this.nameBindingSQLValidator
  ): SettingsProvider =
