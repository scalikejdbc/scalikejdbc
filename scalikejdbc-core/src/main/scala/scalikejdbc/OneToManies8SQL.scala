...
private[scalikejdbc] trait OneToManies8Extractor[A, B1, B2, B3, B4, B5, B6, B7, B8, E <: WithExtractor, Z]
    extends SQL[Z, E]
  ...
  private[scalikejdbc] def transform: (A, Seq[B1], Seq[B2], Seq[B3], Seq[B4], Seq[B5], Seq[B6], Seq[B7], Seq[B8]) => Z
  ...
  private[scalikejdbc] def processResultSet(
    ...
    val (to1, to2, to3, to4, to5, to6, to7, to8) = {
      (extractTo1(rs), extractTo2(rs), extractTo3(rs), extractTo4(rs), extractTo5(rs), extractTo6(rs), extractTo7(rs), extractTo8(rs))
    }
  ...
  private[scalikejdbc] def toTraversable(
    ...
    extractor: (A, Seq[B1], Seq[B2], Seq[B3], Seq[B4], Seq[B5], Seq[B6], Seq[B7], Seq[B8]) => Z): Traversable[Z] = {
    session.foldLeft(statement, parameters: _*)(
      LinkedHashMap[A, (Seq[B1], Seq[B2], Seq[B3], Seq[B4], Seq[B5], Seq[B6], Seq[B7], Seq[B8])]())(processResultSet).map {
        case (one, (t1, t2, t3, t4, t5, t6, t7, t8)) => extractor(one, t1, t2, t3, t4, t5, t6, t7, t8)
      }
  }

}

class OneToManies8SQL[A, B1, B2, B3, B4, B5, B6, B7, B8, E <: WithExtractor, Z](
  ...
  override val parameters: Seq[Any])(one: WrappedResultSet => A)(
    ...
    to8: WrappedResultSet => Option[B8])(
      extractor: (A, Seq[B1], Seq[B2], Seq[B3], Seq[B4], Seq[B5], Seq[B6], Seq[B7], Seq[B8]) => Z)
  ...
  def map(extractor: (A, Seq[B1], Seq[B2], Seq[B3], Seq[B4], Seq[B5], Seq[B6], Seq[B7], Seq[B8]) => Z): OneToManies8SQL[A, B1, B2, B3, B4, B5, B6, B7, B8, HasExtractor, Z] = {
    new OneToManies8SQL(statement, parameters)(one)(to1, to2, to3, to4, to5, to6, to7, to8)(extractor)
  }
  override def toTraversable(): OneToManies8SQLToTraversable[A, B1, B2, B3, B4, B5, B6, B7, B8, E, Z] = {
    new OneToManies8SQLToTraversable[A, B1, B2, B3, B4, B5, B6, B7, B8, E, Z](
      statement, parameters)(one)(to1, to2, to3, to4, to5, to6, to7, to8)(extractor)
  }
  override def toList(): OneToManies8SQLToList[A, B1, B2, B3, B4, B5, B6, B7, B8, E, Z] = {
    new OneToManies8SQLToList[A, B1, B2, B3, B4, B5, B6, B7, B8, E, Z](
      statement, parameters)(one)(to1, to2, to3, to4, to5, to6, to7, to8)(extractor)
  }
  override def toOption(): OneToManies8SQLToOption[A, B1, B2, B3, B4, B5, B6, B7, B8, E, Z] = {
    new OneToManies8SQLToOption[A, B1, B2, B3, B4, B5, B6, B7, B8, E, Z](
      statement, parameters)(one)(to1, to2, to3, to4, to5, to6, to7, to8)(extractor)(true)
  }
  override def headOption(): OneToManies8SQLToOption[A, B1, B2, B3, B4, B5, B6, B7, B8, E, Z] = {
    new OneToManies8SQLToOption[A, B1, B2, B3, B4, B5, B6, B7, B8, E, Z](
      statement, parameters)(one)(to1, to2, to3, to4, to5, to6, to7, to8)(extractor)(false)
  }
  override def toCollection: OneToManies8SQLToCollection[A, B1, B2, B3, B4, B5, B6, B7, B8, E, Z] = {
    new OneToManies8SQLToCollection[A, B1, B2, B3, B4, B5, B6, B7, B8, E, Z](
      statement, parameters)(one)(to1, to2, to3, to4, to5, to6, to7, to8)(extractor)
  }

  override def single(): OneToManies8SQLToOption[A, B1, B2, B3, B4, B5, B6, B7, B8, E, Z] = toOption()
  override def first(): OneToManies8SQLToOption[A, B1, B2, B3, B4, B5, B6, B7, B8, E, Z] = headOption()
  override def list(): OneToManies8SQLToList[A, B1, B2, B3, B4, B5, B6, B7, B8, E, Z] = toList()
  override def traversable(): OneToManies8SQLToTraversable[A, B1, B2, B3, B4, B5, B6, B7, B8, E, Z] = toTraversable()
  override def collection: OneToManies8SQLToCollection[A, B1, B2, B3, B4, B5, B6, B7, B8, E, Z] = toCollection
}

class OneToManies8SQLToList[A, B1, B2, B3, B4, B5, B6, B7, B8, E <: WithExtractor, Z](
  override val statement: String,
  override val parameters: Seq[Any])(one: WrappedResultSet => A)(
    to1: WrappedResultSet => Option[B1],
    to2: WrappedResultSet => Option[B2],
    ...
    with SQLToList[Z, E]
    with AllOutputDecisionsUnsupported[Z, E]
    with OneToManies8Extractor[A, B1, B2, B3, B4, B5, B6, B7, B8, E, Z] {
  ...
  private[scalikejdbc] def transform: (A, Seq[B1], Seq[B2], Seq[B3], Seq[B4], Seq[B5], Seq[B6], Seq[B7], Seq[B8]) => Z = extractor
}

class OneToManies8SQLToCollection[A, B1, B2, B3, B4, B5, B6, B7, B8, E <: WithExtractor, Z](
  override val statement: String,
  override val parameters: Seq[Any])(one: WrappedResultSet => A)(
    to1: WrappedResultSet => Option[B1],
    to2: WrappedResultSet => Option[B2],
...
class OneToManies8SQLToTraversable[A, B1, B2, B3, B4, B5, B6, B7, B8, E <: WithExtractor, Z](
  override val statement: String,
  override val parameters: Seq[Any])(one: WrappedResultSet => A)(
    to1: WrappedResultSet => Option[B1],
    to2: WrappedResultSet => Option[B2],
...
class OneToManies8SQLToOption[A, B1, B2, B3, B4, B5, B6, B7, B8, E <: WithExtractor, Z](
  override val statement: String,
  override val parameters: Seq[Any])(one: WrappedResultSet => A)(
    to1: WrappedResultSet => Option[B1],
    to2: WrappedResultSet => Option[B2],
    ...
    to7: WrappedResultSet => Option[B7],
    to8: WrappedResultSet => Option[B8])(
      extractor: (A, Seq[B1], Seq[B2], Seq[B3], Seq[B4], Seq[B5], Seq[B6], Seq[B7], Seq[B8]) => Z)(protected val isSingle: Boolean = true)
    extends SQL[Z, E](statement, parameters)(SQL.noExtractor[Z]("one-to-many extractor(one(RS => A).toMany(RS => Option[B1])) is specified, use #map((A,B) =>Z) instead."))
