...
class OneToManies7SQL[A, B1, B2, B3, B4, B5, B6, B7, E <: WithExtractor, Z](
  ...
  def map(extractor: (A, Seq[B1], Seq[B2], Seq[B3], Seq[B4], Seq[B5], Seq[B6], Seq[B7]) => Z): OneToManies7SQL[A, B1, B2, B3, B4, B5, B6, B7, HasExtractor, Z] = {
    new OneToManies7SQL(statement)(parameters: _*)(output)(one)(to1, to2, to3, to4, to5, to6, to7)(extractor)
  }
  override def toTraversable(): OneToManies7SQLToTraversable[A, B1, B2, B3, B4, B5, B6, B7, E, Z] = {
    new OneToManies7SQLToTraversable[A, B1, B2, B3, B4, B5, B6, B7, E, Z](
      statement)(parameters: _*)(one)(to1, to2, to3, to4, to5, to6, to7)(extractor)
  }
...
class OneToManies7SQLToList[A, B1, B2, B3, B4, B5, B6, B7, E <: WithExtractor, Z](override val statement: String)(override val parameters: Any*)(one: WrappedResultSet => A)(
  to1: WrappedResultSet => Option[B1],
  to2: WrappedResultSet => Option[B2],
  to3: WrappedResultSet => Option[B3],
  to4: WrappedResultSet => Option[B4],
...
class OneToManies7SQLToTraversable[A, B1, B2, B3, B4, B5, B6, B7, E <: WithExtractor, Z](override val statement: String)(override val parameters: Any*)(one: WrappedResultSet => A)(
  to1: WrappedResultSet => Option[B1],
  to2: WrappedResultSet => Option[B2],
  to3: WrappedResultSet => Option[B3],
  to4: WrappedResultSet => Option[B4],
...
class OneToManies7SQLToOption[A, B1, B2, B3, B4, B5, B6, B7, E <: WithExtractor, Z](override val statement: String)(override val parameters: Any*)(one: WrappedResultSet => A)(
  to1: WrappedResultSet => Option[B1],
  to2: WrappedResultSet => Option[B2],
  to3: WrappedResultSet => Option[B3],
  to4: WrappedResultSet => Option[B4],
