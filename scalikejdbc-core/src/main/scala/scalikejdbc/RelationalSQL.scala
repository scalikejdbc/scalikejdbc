...
class OneToXSQL[A, E <: WithExtractor, Z](
  ...
  def toMany[B](to: WrappedResultSet => Option[B]): OneToManySQL[A, B, E, Z] = {
    new OneToManySQL(statement, rawParameters)(one)(to)((a, bs) => a.asInstanceOf[Z])
  }
  ...
  def toManies[B1, B2](
    ...
    new OneToManies2SQL(statement, rawParameters)(one)(to1, to2)((a, bs1, bs2) => a.asInstanceOf[Z])
  }
  ...
  def toManies[B1, B2, B3](
    ...
    new OneToManies3SQL(statement, rawParameters)(one)(to1, to2, to3)((a, bs1, bs2, bs3) => a.asInstanceOf[Z])
  }
  ...
  def toManies[B1, B2, B3, B4](
    ...
    new OneToManies4SQL(statement, rawParameters)(one)(to1, to2, to3, to4)((a, bs1, bs2, bs3, bs4) => a.asInstanceOf[Z])
  }
  ...
  def toManies[B1, B2, B3, B4, B5](
    ...
    new OneToManies5SQL(statement, rawParameters)(one)(to1, to2, to3, to4, to5)((a, bs1, bs2, bs3, bs4, bs5) => a.asInstanceOf[Z])
  }
  ...
  def toManies[B1, B2, B3, B4, B5, B6](
    ...
    new OneToManies6SQL(statement, rawParameters)(one)(to1, to2, to3, to4, to5, to6)((a, bs1, bs2, bs3, bs4, bs5, bs6) => a.asInstanceOf[Z])
  }
  ...
  def toManies[B1, B2, B3, B4, B5, B6, B7](
    ...
    new OneToManies7SQL(statement, rawParameters)(one)(to1, to2, to3, to4, to5, to6, to7)((a, bs1, bs2, bs3, bs4, bs5, bs6, bs7) => a.asInstanceOf[Z])
  }
  ...
  def toManies[B1, B2, B3, B4, B5, B6, B7, B8](
    ...
    new OneToManies8SQL(statement, rawParameters)(one)(to1, to2, to3, to4, to5, to6, to7, to8)((a, bs1, bs2, bs3, bs4, bs5, bs6, bs7, bs8) => a.asInstanceOf[Z])
  }
  ...
  def toManies[B1, B2, B3, B4, B5, B6, B7, B8, B9](
    ...
    new OneToManies9SQL(statement, rawParameters)(one)(to1, to2, to3, to4, to5, to6, to7, to8, to9)((a, bs1, bs2, bs3, bs4, bs5, bs6, bs7, bs8, bs9) => a.asInstanceOf[Z])
  }
