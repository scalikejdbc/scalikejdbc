...
private[scalikejdbc] class DBConnectionAttributesWiredResultSet(
  ...
  private[this] def convertTimeZoneIfNeeded(timestamp: Timestamp): Timestamp =
    if (connAttributes.timeZoneSettings.conversionEnabled) {
      ...
      TimeZoneConverter.from(serverTimeZone).to(clientTimeZone).convert(timestamp)
    } else {
      timestamp
    }
  ...
  def getTimestamp(columnIndex: Int): Timestamp = convertTimeZoneIfNeeded(underlying.getTimestamp(columnIndex))
  ...
  def updateTimestamp(columnIndex: Int, x: Timestamp): Unit = underlying.updateTimestamp(columnIndex, x)
  def updateTimestamp(columnLabel: String, x: Timestamp): Unit = underlying.updateTimestamp(columnLabel, x)
  ...
  def updateDate(columnIndex: Int, x: Date): Unit = underlying.updateDate(columnIndex, x)
  def updateDate(columnLabel: String, x: Date): Unit = underlying.updateDate(columnLabel, x)
  ...
  def getBinaryStream(columnIndex: Int): InputStream = underlying.getBinaryStream(columnIndex)
  def getBinaryStream(columnLabel: String): InputStream = underlying.getBinaryStream(columnLabel)
  ...
  def updateNCharacterStream(columnLabel: String, reader: Reader, length: Long): Unit = underlying.updateNCharacterStream(columnLabel, reader, length)
  def updateNCharacterStream(columnIndex: Int, x: Reader): Unit = underlying.updateNCharacterStream(columnIndex, x)
  def updateNCharacterStream(columnLabel: String, reader: Reader): Unit = underlying.updateNCharacterStream(columnLabel, reader)
  def updateNClob(columnIndex: Int, nClob: NClob): Unit = underlying.updateNClob(columnIndex, nClob)
  def updateNClob(columnLabel: String, nClob: NClob): Unit = underlying.updateNClob(columnLabel, nClob)
  def updateNClob(columnIndex: Int, reader: Reader, length: Long): Unit = underlying.updateNClob(columnIndex, reader, length)
  def updateNClob(columnLabel: String, reader: Reader, length: Long): Unit = underlying.updateNClob(columnLabel, reader, length)
  def updateNClob(columnIndex: Int, reader: Reader): Unit = underlying.updateNClob(columnIndex, reader)
  def updateNClob(columnLabel: String, reader: Reader): Unit = underlying.updateNClob(columnLabel, reader)
  ...
  def getCharacterStream(columnIndex: Int): Reader = underlying.getCharacterStream(columnIndex)
  def getCharacterStream(columnLabel: String): Reader = underlying.getCharacterStream(columnLabel)
  def updateArray(columnIndex: Int, x: Array): Unit = underlying.updateArray(columnIndex, x)
  def updateArray(columnLabel: String, x: Array): Unit = underlying.updateArray(columnLabel, x)
  ...
  def updateBlob(columnIndex: Int, x: Blob): Unit = underlying.updateBlob(columnIndex, x)
  def updateBlob(columnLabel: String, x: Blob): Unit = underlying.updateBlob(columnLabel, x)
  def updateBlob(columnIndex: Int, inputStream: InputStream, length: Long): Unit = underlying.updateBlob(columnIndex, inputStream, length)
  def updateBlob(columnLabel: String, inputStream: InputStream, length: Long): Unit = underlying.updateBlob(columnLabel, inputStream, length)
  def updateBlob(columnIndex: Int, inputStream: InputStream): Unit = underlying.updateBlob(columnIndex, inputStream)
  def updateBlob(columnLabel: String, inputStream: InputStream): Unit = underlying.updateBlob(columnLabel, inputStream)
  ...
  def getBigDecimal(columnIndex: Int, scale: Int): BigDecimal = underlying.getBigDecimal(columnIndex, scale)
  def getBigDecimal(columnLabel: String, scale: Int): BigDecimal = underlying.getBigDecimal(columnLabel, scale)
  def getBigDecimal(columnIndex: Int): BigDecimal = underlying.getBigDecimal(columnIndex)
  def getBigDecimal(columnLabel: String): BigDecimal = underlying.getBigDecimal(columnLabel)
  ...
  def getNString(columnLabel: String): String = underlying.getNString(columnLabel)
  def deleteRow(): Unit = underlying.deleteRow()
  def getConcurrency: Int = underlying.getConcurrency
  def updateObject(columnIndex: Int, x: scala.Any, scaleOrLength: Int): Unit = underlying.updateObject(columnIndex, x, scaleOrLength)
  ...
  def getTime(columnIndex: Int, cal: Calendar): Time = underlying.getTime(columnIndex, cal)
  def getTime(columnLabel: String, cal: Calendar): Time = underlying.getTime(columnLabel, cal)
  def updateCharacterStream(columnIndex: Int, x: Reader, length: Int): Unit = underlying.updateCharacterStream(columnIndex, x, length)
  def updateCharacterStream(columnLabel: String, reader: Reader, length: Int): Unit = underlying.updateCharacterStream(columnLabel, reader, length)
  ...
  def updateCharacterStream(columnLabel: String, reader: Reader, length: Long): Unit = underlying.updateCharacterStream(columnLabel, reader, length)
  def updateCharacterStream(columnIndex: Int, x: Reader): Unit = underlying.updateCharacterStream(columnIndex, x)
  def updateCharacterStream(columnLabel: String, reader: Reader): Unit = underlying.updateCharacterStream(columnLabel, reader)
  ...
  def getBoolean(columnLabel: String): Boolean = underlying.getBoolean(columnLabel)
  ...
  def updateRef(columnIndex: Int, x: Ref): Unit = underlying.updateRef(columnIndex, x)
  def updateRef(columnLabel: String, x: Ref): Unit = underlying.updateRef(columnLabel, x)
  def getAsciiStream(columnIndex: Int): InputStream = underlying.getAsciiStream(columnIndex)
  ...
  def getNCharacterStream(columnLabel: String): Reader = underlying.getNCharacterStream(columnLabel)
  ...
  def updateClob(columnIndex: Int, x: Clob): Unit = underlying.updateClob(columnIndex, x)
  def updateClob(columnLabel: String, x: Clob): Unit = underlying.updateClob(columnLabel, x)
  def updateClob(columnIndex: Int, reader: Reader, length: Long): Unit = underlying.updateClob(columnIndex, reader, length)
  def updateClob(columnLabel: String, reader: Reader, length: Long): Unit = underlying.updateClob(columnLabel, reader, length)
  def updateClob(columnIndex: Int, reader: Reader): Unit = underlying.updateClob(columnIndex, reader)
  def updateClob(columnLabel: String, reader: Reader): Unit = underlying.updateClob(columnLabel, reader)
  ...
  def getDate(columnIndex: Int, cal: Calendar): Date = underlying.getDate(columnIndex)
  def getDate(columnLabel: String, cal: Calendar): Date = underlying.getDate(columnLabel)
  ...
  def getUnicodeStream(columnIndex: Int): InputStream = underlying.getUnicodeStream(columnIndex)
  def getUnicodeStream(columnLabel: String): InputStream = underlying.getUnicodeStream(columnLabel)
  ...
  def updateTime(columnIndex: Int, x: Time): Unit = underlying.updateTime(columnIndex, x)
  def updateTime(columnLabel: String, x: Time): Unit = underlying.updateTime(columnLabel, x)
  ...
  def getBytes(columnIndex: Int): scala.Array[Byte] = underlying.getBytes(columnIndex)
  def getBytes(columnLabel: String): scala.Array[Byte] = underlying.getBytes(columnLabel)
  def updateBytes(columnIndex: Int, x: scala.Array[Byte]): Unit = underlying.updateBytes(columnIndex, x)
  def updateBytes(columnLabel: String, x: scala.Array[Byte]): Unit = underlying.updateBytes(columnLabel, x)
