...
class WrappedResultSetSpec extends FlatSpec with ShouldMatchers with MockitoSugar {
  ...
  it should "have expected methods" in {
    ...
    {
      val res1: java.lang.Boolean = rs.boolean("foo")
      val res2: java.lang.Boolean = rs.boolean(0)
    ...
    {
      val res1: java.lang.Byte = rs.byte("foo")
      val res2: java.lang.Byte = rs.byte(0)
    ...
    {
      val res1: java.lang.Double = rs.double("foo")
      val res2: java.lang.Double = rs.double(0)
    ...
    {
      val res1: java.lang.Float = rs.float("foo")
      val res2: java.lang.Float = rs.float(0)
    ...
    {
      val res1: java.lang.Integer = rs.int("foo")
      val res2: java.lang.Integer = rs.int(0)
    ...
    {
      val res1: java.lang.Long = rs.long("foo")
      val res2: java.lang.Long = rs.long(0)
    ...
    {
      val res1: java.lang.Short = rs.short("foo")
      val res2: java.lang.Short = rs.short(0)
