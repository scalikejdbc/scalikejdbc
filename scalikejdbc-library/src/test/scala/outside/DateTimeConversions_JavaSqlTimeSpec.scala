...
class DateTimeConversions_JavaSqlTimeSpec extends FlatSpec with ShouldMatchers {

  behavior of "implicit conversions for java.util.Time"
  ...
  it should "have #toDateTime" in {
    val date = datetime.toDate.toSqlTime
