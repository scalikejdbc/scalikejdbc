...
pushd "%root_dir%"
  ...
  call cscript "%self_path%" //E:JScript //Nologo https://repo1.maven.org/maven2/org/scala-sbt/sbt-launch/1.5.2/sbt-launch-1.5.2.jar
popd
...
>>"%build_sbt%" echo.
>>"%build_sbt%" echo scalaVersion := "2.12.14"
>>"%build_sbt%" echo.
