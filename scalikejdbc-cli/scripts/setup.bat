...
pushd "%root_dir%"
  ...
  call cscript "%self_path%" //E:JScript //Nologo https://oss.sonatype.org/content/repositories/releases/org/scala-sbt/sbt-launch/1.2.4/sbt-launch.jar
popd
...
>>"%build_sbt%" echo.
>>"%build_sbt%" echo scalaVersion := "2.12.7"
>>"%build_sbt%" echo.
