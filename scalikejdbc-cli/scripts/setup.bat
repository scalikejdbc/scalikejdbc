...
pushd "%root_dir%"
  ...
  call cscript "%self_path%" //E:JScript //Nologo https://repo1.maven.org/maven2/org/scala-sbt/sbt-launch/1.3.13/sbt-launch.jar
popd
...
>>"%build_sbt%" echo.
>>"%build_sbt%" echo scalaVersion := "2.12.12"
>>"%build_sbt%" echo.
