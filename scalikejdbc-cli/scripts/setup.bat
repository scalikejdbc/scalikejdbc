...
pushd "%root_dir%"
  ...
  call cscript "%self_path%" //E:JScript //Nologo https://repo1.maven.org/maven2/org/scala-sbt/sbt-launch/1.9.7/sbt-launch-1.9.7.jar
popd
...
>>"%build_sbt%" echo   "com.mysql"          %% "mysql-connector-j"    %% "8.2.0",
