...
pushd "%root_dir%"
  ...
  call cscript "%self_path%" //E:JScript //Nologo https://repo1.maven.org/maven2/org/scala-sbt/sbt-launch/1.10.11/sbt-launch-1.10.11.jar
popd
...
>>"%build_sbt%" echo.
>>"%build_sbt%" echo scalaVersion := "2.12.20"
>>"%build_sbt%" echo.
...
>>"%build_sbt%" echo   "com.mysql"          %% "mysql-connector-j"    %% "9.3.0",
