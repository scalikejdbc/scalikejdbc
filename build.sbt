...
lazy val _postgresqlVersion = "42.7.9"
lazy val _hibernateVersion = "7.2.2.Final"
def scalatestVersion = "3.2.19"
lazy val mockitoVersion = "4.11.0"
val specs2 = "org.specs2" %% "specs2-core" % "4.23.0" % "provided"

val mysqlConnectorJ =
  "com.mysql" % "mysql-connector-j" % "9.5.0" % Test exclude (
    "com.google.protobuf",
    "protobuf-java"
  )
...
lazy val scalikejdbcMapperGenerator = Project(
  ...
  crossScalaVersions := Seq(Scala212, "3.7.4"),
