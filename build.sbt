...
ThisBuild / version := "4.2.2-SNAPSHOT"
...
lazy val _slf4jApiVersion = "2.0.12"
...
lazy val _hibernateVersion = "6.4.9.Final"
def scalatestVersion = "3.2.18"
lazy val mockitoVersion = "4.11.0"
val specs2 = "org.specs2" %% "specs2-core" % "4.20.7" % "provided"
