...
lazy val _slf4jApiVersion = "2.0.19"
lazy val _typesafeConfigVersion = "1.4.9"
...
lazy val _hibernateVersion = "7.4.7.Final"
  ...
  .settings(
    ...
    libraryDependencies ++= {
      Seq(
        ...
        "org.scala-lang.modules" %% "scala-parser-combinators" % "2.5.0" % "compile",
  ...
  .settings(
    ...
    libraryDependencies ++= {
      Seq(
        ...
        "org.slf4j" % "slf4j-api" % _slf4jApiVersion % "compile",
        "ch.qos.logback" % "logback-classic" % _logbackVersion % "test",
        "org.scalatestplus" %% "testng-7-12" % "3.2.20.0" % "test",
